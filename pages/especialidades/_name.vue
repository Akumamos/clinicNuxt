...
export default {
  ...
  head () {
    return {
     ...
     meta: [
       { hid: 'description', name: 'description', content: 'Especialidade ' + this.specialities_details.name + '. Médicos: ' + this.doctors_name + '. Venha visitar nos em Évora, faça a sua marcação através do 266 745 990 ou 926 649 111 ou online.' },
